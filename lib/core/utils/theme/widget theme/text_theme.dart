...
class UTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: UColors.dark),
    bodySmall: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w500, color: UColors.dark.withValues(alpha: 0.5)),

    labelLarge: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: UColors.dark),
    labelMedium: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: UColors.dark.withValues(alpha: 0.5)),
    labelSmall: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: UColors.dark.withValues(alpha: 0.5)),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: UColors.light),
    bodySmall: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w500, color: UColors.light.withValues(alpha: 0.5)),


    labelLarge: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: UColors.light),
    labelMedium: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: UColors.light.withValues(alpha: 0.5)),
    labelSmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: UColors.light.withValues(alpha: 0.5)),
  );
}